...
class HtmlRenderer {
    ...
    renderDefaultStyle() {
        ...
        var styleText = `
.${c}-wrapper { background: gray; padding: 30px; padding-bottom: 0px; display: flex; flex-flow: column; align-items: center; overflow: scroll;} 
.${c}-wrapper>section.${c} { background: white; box-shadow: 0 0 10px rgba(0, 0, 0, 0.5); margin-bottom: 30px; max-width: 100vw;}
.${c} { color: black; }
